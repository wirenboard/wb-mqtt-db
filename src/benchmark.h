...
//! RAII-style spend time benchmark. Calculates time period between construction
//! and destruction of an object, prints the time into log.
class TBenchmark
{
    std::string Message;
...
public:
     ...
     * @param enabled true - print and calculate spend time in destructor, false -
     * do nothig, wait Enable call
     */
